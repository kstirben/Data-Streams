...
// Phant Stuff //
/////////////////
const String publicKey = "robbgXr4d0Fyx20vwWEM";
const String privateKey = "jkzzY18BNqTYMk49n51m";
const byte NUM_FIELDS = 8;
const String fieldNames[NUM_FIELDS] = {"humidity", "latitude", "light_lvl", "longitude", "pressure", "tempf", "winddir",  "windspdmph"};
